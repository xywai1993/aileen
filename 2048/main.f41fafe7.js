...
"use strict";require("./style.css");var n=require("./tool"),e=o(n);function o(n){return n&&n.__esModule?n:{default:n}}var u=4,t=4,l=20,r=0,a=document.querySelector("#canvas"),c=a.getContext("2d"),f=[],i=function(n,o){c.fillStyle="#999",e.default.createArray(n).forEach(function(n){e.default.createArray(o).forEach(function(e){var o=d(n,e);c.fillRect(o.left,o.top,r,r)})})},m=function(n,e,o){var t=d(e,o);c.fillStyle="#fff",c.font="48px serif";var l=r/2;c.fillText(String(n),t.left+l-11,t.top+l+15),f[e*u+o].num=n},d=function(n,e){return{top:n*r+(n+1)*l,left:e*r+(e+1)*l}},v=function(){var n=document.documentElement.offsetWidth;console.log(n),r=Math.ceil((n-l*(t+1))/t),l=Math.floor((n-r*t)/5),console.log(r,l),a.width=n-2,a.height=n-2},p=function(n,o){e.default.createArray(n).forEach(function(n){e.default.createArray(o).forEach(function(e){f.push({num:"",row:n,col:e})})})},s=function(){var n=f.filter(function(n,e){return!n.num});if(console.log(n),!(n.length<=0)){var e=n[Math.floor(Math.random()*n.length)],o=Math.floor(100*Math.random())>50?2:4;m(o,e.row,e.col)}},h=function(){for(var n=!0,e=f.filter(function(n,e){return!n.num}),o=0;o<f.length;o++){var u=f[o],l=0===u.row?null:f[o-t].num,r=3===u.row?null:f[o+t].num,a=0===u.col?null:f[o-1].num,c=3===u.col?null:f[o+1].num,i=u.num;if(i===l||i===r||i===a||i===c){n=!1;break}}return 0===e.length&&n},w=function(){var n=function(){var n=[];return e.default.createArray(u).map(function(o){var t=e.default.deepClone(f);n.push(t.slice(o*u,(o+1)*u))}),console.log(e.default.deepClone(n)),n},o=function(){n().map(function(n){var o=0;n.map(function(n,t){if(n.num){var l=n.row*u+n.col;o&&(f[l-o].num=e.default.deepClone(n.num),f[l].num="")}else o++})})};o(),console.log(e.default.deepClone(f)),n().map(function(n){n.map(function(e,o){if(e.num){var t=e.row*u+e.col,l=n[o+1]?n[o+1]:null;l&&e.num===l.num&&f[t].num===e.num&&(f[t].num=2*e.num,f[t+1].num="")}})}),o(),console.log(f)},g=function(){var n=function(){var n=[];return e.default.createArray(u).map(function(o){var t=e.default.deepClone(f);n.push(t.slice(o*u,(o+1)*u))}),console.log(e.default.deepClone(n)),n},o=function(){n().map(function(n){var o=0;n.map(function(l,r){var a=n[t-r-1];if(a.num){var c=a.row*u+a.col;o&&(f[c+o].num=e.default.deepClone(a.num),f[c].num="")}else o++})})};o(),n().map(function(n){n.map(function(e,o){var l=n[t-o-1];if(l.num){var r=l.row*u+l.col,a=n[t-o-2]?n[t-o-2]:null;a&&l.num===a.num&&f[r].num===l.num&&(f[r].num=2*l.num,f[r-1].num="")}})}),o()},C=function(){var n=function(){var n=[];return e.default.deepClone(f).map(function(e,o){n[e.col]=n[e.col]?n[e.col]:[],n[e.col][e.row]=e}),console.log(n),n},o=function(){n().map(function(n){var o=0;n.map(function(n,t){if(n.num){var l=n.row*u+n.col;o&&(f[l-o*u].num=e.default.deepClone(n.num),f[l].num="")}else o++})})};o(),n().map(function(n){n.map(function(e,o){if(e.num){var t=e.row*u+e.col,l=n[o+1]?n[o+1]:null;l&&e.num===l.num&&f[t].num===e.num&&(f[t].num=2*e.num,f[t+u].num="")}})}),o()},y=function(){var n=function(){var n=[];return e.default.deepClone(f).map(function(e){n[e.col]=n[e.col]?n[e.col]:[],n[e.col][e.row]=e}),console.log(n),n},o=function(){n().map(function(n){var o=0;n.map(function(t,l){var r=n[u-l-1];if(r.num){var a=r.row*u+r.col;o&&(f[a+o*u].num=e.default.deepClone(r.num),f[a].num="")}else o++})})};o(),n().map(function(n){n.map(function(e,o){var t=n[u-o-1];if(t.num){var l=t.row*u+t.col,r=n[u-o-2]?n[u-o-2]:null;r&&t.num===r.num&&f[l].num===t.num&&(f[l].num=2*t.num,f[l-u].num="")}})}),o()},E=function(){h()?alert("你死了"):(c.clearRect(0,0,a.width,a.height),i(u,t),f.map(function(n){n.num&&m(n.num,n.row,n.col)}),s())};p(u,t),v(),i(u,t),s(),s(),e.default.touchDirection(a,function(n){if(console.log(n),n.isTouch){switch(n.dir){case"left":w();break;case"right":g();break;case"top":C();break;case"bottom":y()}E()}});var k={LEFT:37,UP:38,RIGHT:39,DOWN:40};document.addEventListener("keydown",function(n){switch(n.keyCode){case k.UP:C();break;case k.RIGHT:g();break;case k.DOWN:y();break;case k.LEFT:w()}E()}),document.addEventListener("touchmove",function(n){n.preventDefault()}),document.addEventListener("touchend",function(n){n.preventDefault()});
},{"./style.css":"GqqL","./tool":"vv5C"}]},{},["+gvT"], null)
//# sourceMappingURL=main.f41fafe7.map